...
export const Sprites = {
    ...
    robotPice1:new Sprite('robotPice1', SpriteCategory.Decoration, 'Images/Sprites/Decorations/robotPice1.webp', 70,70),
    robotPice2:new Sprite('robotPice2', SpriteCategory.Decoration, 'Images/Sprites/Decorations/robotPice2.webp', 70,70),
    robotPice3:new Sprite('robotPice3', SpriteCategory.Decoration, 'Images/Sprites/Decorations/robotPice3.webp', 70,70),
    robotPice4:new Sprite('robotPice4', SpriteCategory.Decoration, 'Images/Sprites/Decorations/robotPice4.webp', 70,70),
    FamilyPizza:new Sprite('FamilyPizza', SpriteCategory.CollectableItem, 'Images/Sprites/Collectables/full-pizza.webp', 70,70),
